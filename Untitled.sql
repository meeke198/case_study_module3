...
insert into users(name, email, country) values('Hoa','minh@codegym.vn','Viet Nam');
insert into users(name, email, country) values('Mai','minh@codegym.vn','Viet Nam');
insert into users(name, email, country) values('Thuy','minh@codegym.vn','Viet Nam');
